	...
	render: function(loaded) {
		...
		if (zs) {
			...
			o = s.option(form.Value, 'swappiness', _('System swappiness'),
				_('The tendency of the system to swap unused pages instead of dropping filesystem cache. If your filesystem is compressed, such as SQUASHFS, UBI or zfs, use a slightly higher swappiness.'));
