	...
	render: function(loaded) {
		...
		if (zs) {
			...
			o = s.option(form.Value, 'swappiness', _('System swappiness'),
				_('This is tendency of the system to swap unused pages instead of dropping filesystem cache. If your root filesystem is compressed, such as an SQUASHFS root or UBI overlay, use a higher swappiness. This will allow the system to keep the uncompressed filesystem in memory, which is useful becuase SQUASHFS and UBI blocks are expensive to uncompress.'));
